...
test_item.delete = MagicMock(return_value=None)
api.sync_api.items.get_by_id = MagicMock(return_value=test_item)
api.sync_api.projects.get_data = MagicMock(
    return_value={"items": [test_item_data]}
)
...
def test_update_task():
    update_data = {"priority": 4, "description": "Updated from PyTest"}
...
def test_delete_task():
    ...
    test_item.delete.assert_called()
